<div class="text-sm font-regular text-gray-900 flex mt-4 flex items-center justify-between">
                                <div class="flex">
            ...
            c0-11.797,9.536-21.333,21.333-21.333s21.333,9.536,21.333,21.333V256z"
                                        ...
                                        <span class="ml-1">{{ \Carbon\Carbon::parse($post['date'])->diffForHumans() }}</span>
                                </div>
                                <div class="share flex items-center">
                                    <span class="uppercase font-semibold mr-2">Share</span>
                                    <svg
                                        class="h-6 mr-2"
                                        version="1.1"
                                        id="Layer_1"
