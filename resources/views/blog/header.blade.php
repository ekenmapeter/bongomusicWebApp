        <header class="bg-white p-4 px-8 border-b border-gray-100 mb-2">
            <section class="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-12 items-center">
                <div class="col-span-9">
                    <div class="w-64">
                        <img src="http://reporterly.net/wp-content/themes/sharks/assets/images/logo.png" class="w-full" />
                    </div>
                </div>
                <div class="cols-span-1 md:col-span-3 flex md:gap-3 items-center justify-between md:justify-end">
                    <svg
                        class="h-8"
                        version="1.1"
                        id="Layer_1"
                    ...
                    >
                        ...
                        <path
                            style="fill: #a81411;"
                            d="M384.857,170.339c-7.677,2.343-15.682,4.356-23.699,6.361
