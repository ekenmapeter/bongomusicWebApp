<div class="hidden md:block lg:block xl:block sticky top-0 bg-white flex flex-col justify-between h-screen overflow-x-hidden p-8 pt-0 pr-1">
                        <ul class="navigationbar my-5 border-y flex flex-col text-lg">
                            <li>
                                <a href="#" class="text-red-800 hover:text-red-700 px-5 py-3 hover:bg-red-50 font-semibold flex items-center">
                                    <svg class="h-8 text-red-800" fill="currentColor" viewBox="0 0 24 24" id="_24x24_On_Light_Queue-In" data-name="24x24/On Light/Queue-In" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path
                                            ...
                                            fill="currentColor"
                                        />
                                        <path id="Shape-2" data-name="Shape" d="M.75,1.5h5a.75.75,0,0,0,0-1.5h-5a.75.75,0,0,0,0,1.5Z" transform="translate(17.25 8.75) rotate(-180)" fill="currentColor" />
                                    </svg>
                            ...
                            <li>
                                <a href="#" class="flex items-center hover:text-red-700 px-5 py-3 hover:bg-red-50">
                                    <svg class="h-8" fill="currentColor" viewBox="0 0 24 24" id="_24x24_On_Light_Notification-Alert" data-name="24x24/On Light/Notification-Alert" xmlns="http://www.w3.org/2000/svg">
                                        <rect id="view-box" width="24" height="24" fill="none" />
                                        <path
                                            id="Shape"
                                    ...
                                    <span class="ml-2">Latest Stories</span>
                                </a>
                            </li>

                            <li>
                                <a href="#" class="flex items-center hover:text-red-700 px-5 py-3 hover:bg-red-50">
                                    <svg class="h-7 ml-1 mr-1" fill="currentColor" viewBox="0 0 512 512" style="enable-background: new 0 0 512 512;" xml:space="preserve">
                                        <g>
                                            <g>
                                                <path
            ...
            C436.238,381.079,433.541,379.179,431.254,376.566z"
                                    ...
                                    <span class="ml-2">Beyond Afg</span>
                                </a>
                            </li>

                            <li>
                                <a href="#" class="flex items-center hover:text-red-700 px-5 py-3 hover:bg-red-50">
                                    <svg class="h-8" fill="currentColor" viewBox="0 0 24 24" id="_24x24_On_Light_Messages" data-name="24x24/On Light/Messages" xmlns="http://www.w3.org/2000/svg">
                                        <rect id="view-box" width="24" height="24" fill="none" />
                                        <path
                                            id="Shape"
                                    ...
                                    <span class="ml-2">Narratives</span>
                                </a>
                            </li>

                            <li>
                                <a href="#" class="flex items-center hover:text-red-700 px-5 py-3 hover:bg-red-50">
                                    <svg class="h-8" fill="currentColor" viewBox="0 0 24 24" id="_24x24_On_Light_Mic" data-name="24x24/On Light/Mic" xmlns="http://www.w3.org/2000/svg">
                                        <rect id="view-box" width="24" height="24" fill="none" />
                                        <path
                                            id="Shape"
                                    ...
                                    <span class="ml-2">Social Voices</span>
                                </a>
                            </li>

                            <li>
                                <a href="#" class="flex items-center hover:text-red-700 px-5 py-3 hover:bg-red-50">
                                    <svg class="h-8" fill="currentColor" viewBox="0 0 24 24" id="_24x24_On_Light_Play" data-name="24x24/On Light/Play" xmlns="http://www.w3.org/2000/svg">
                                        <rect id="view-box" width="24" height="24" fill="none" />
                                        <path
                                            id="Shape"
